...
public class NewJFrame extends javax.swing.JFrame {
 ...
 public NewJFrame() {
    ...
    private void ae93_jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ae93_jButton1ActionPerformed
        ...
        String sifre=ae93_jPasswordField1.getText();
        if(sifre.equals("123"))
        {
            myModel=(DefaultTableModel) ae93_jTable1.getModel();
    ...
    private void ae93_jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ae93_jButton2ActionPerformed
       ...
       myModel=(DefaultTableModel) ae93_jTable1.getModel();
       String ae93_temp=ae93_jFormattedTextField3.getText();
       System.out.println(myModel.getRowCount());
       for(int j=0;j<myModel.getRowCount();j++)
       {
            if(myModel.getValueAt(j,3).equals(ae93_temp))
            {
    ...
    private void ae93_jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ae93_jButton3ActionPerformed
        myModel.setValueAt(ae93_jFormattedTextField4.getText(),  ae93_jTable1.getSelectedRow() ,2);
